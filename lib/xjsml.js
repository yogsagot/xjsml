...
module.exports = class xjsml {
    constructor(params) {
        ...
        this.renderFile = function (filename, args, cb) {
            ...
            return this.renderTag(parsed, args);
        }

        this.express = function (apparg) {
            let engine = this;
            let app = apparg;
            return function (filename, args, cb) {
                var sessionvars = {};
                console.log(app.request);
                if (app.request.xjsmlsessionvars !== undefined) {
                    sessionvars = app.request.xjsmlsessionvars;
                }
                var localvars = {
                    ...args,
                    ...sessionvars
                ...
                return cb(null, engine.renderTag(parsed, localvars));
            }
        }
