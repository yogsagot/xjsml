...
module.exports = class xjsml {
    constructor(params) {
        ...
        this.caseSensitive = params.hasOwnProperty("caseSensitive") ? params.caseSensitive : false;
        ...
        this.attrValue = function (attr, values) {
            ...
            attr.modifiers.forEach(mod => {
                ...
                value = this.registeredModifiers[mod.name].call(attr, value, modvalue);
            });
            return value;
        }
        ...
        this.renderFile = function (filename, args, cb) {
            ...
            console.log(this);
            var parsed = this.parse(template, filename);
            var localvars = {
                ...args,
                ...this.globals
            }
        ...
        this.express = function () {
            ...
            return function (filename, args, cb) {
                ...
                try {
                    var parsed = engine.parse(template, filename);
